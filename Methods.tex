...
lair. %The total amount of food that a pollinator can eat is limited
%by the stomach size, $c_{\text{max}}$.
...
When a flower is pollinated it must be determined which previous plant donated
